    ...
    public partial class CreateNotificationTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserInstructors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserInstructors_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourseOverview = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBuyed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserCourses_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_Paragraphs_ParagraphId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserCourses_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserInstructors_AppUserId",
